...
import 'package:office_shopping_mall/feature/product/data/product_service.dart';
...
List<SingleChildWidget> productModule = [
  ...
  Provider<ProductRepository>(create: (context) => ProductRepositoryImpl(context.read<ProductService>())),
  ...
  ChangeNotifierProvider<ProductDataViewModel>(
    create: (context) => ProductDataViewModel(context.read<ProductRepository>()),
  ),
];