...
import 'package:office_shopping_mall/feature/cart/presentation/widgets/delivery_navigation.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: _selectIndex == 0
            ? Text("장바구니", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold))
              ...
              children: [
                ...
                ProductList(
                  products: context
                      .watch<ProductProvider>()
                      .products
                      .where((a) => a.productDeliveryIndex == 2)
                      .toList(),
                ),
                //배송 완료
                ProductList(
