...
import 'package:office_shopping_mall/feature/cart/domian/cart_repository_impl.dart';
...
List<SingleChildWidget> cartModule = [
  Provider<CartService> (
    create: (context) => CartService(context.read<Dio>()),
  ),
  Provider<CartRepository> (
    create: (context) => CartRepositoryImpl(context.read<CartService>()),
  ),

  ChangeNotifierProvider<CartViewModel>(
    create: (context) =>
    CartViewModel(context.read<CartRepository>(), context.read<CartService>())..loadCarts(),
  )
];